...
<template>
  <article class="c-post">
    ...
    <div class="u-flex-line-between">
      <div class="c-post__actions">
        <template v-if="isConnected">
          <button class="c-post__action" @click="isCommentActive = true">
          ...
          <button class="c-post__action" @click="handleLike(id)">
          ...
          <button class="c-post__action" @click="handleShare(id)">
    ...
    <Comments v-if="isCommentActive" @close="isCommentActive = false" counter="0"/>
  </article>
</template>
